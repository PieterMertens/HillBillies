...
public class Unit {
	...
	public double getCurrentSpeed() {
		...
		double currentSpeed;
		double baseSpeed = 1.5 * (this.getStrength() + this.getAgility()) / (200 * this.getWeight() / 100);// TODO weight vn bouldres en logs inrekening brengen
		if (this.getIsSprinting())
			baseSpeed *= 2;
	...
	public void moveToAdjecent(int dx, int dy, int dz) throws IllegalArgumentException {
		...
		if (!isValidTarget(newPosition))
			...
			// System.out.println("new AdjTarget: " + adjecentTarget[0] + " " + adjecentTarget[1] + " " + adjecentTarget[2]);
	 ...
	 * TO BE ADDED TO CLASS HEADING
	 * 
	 * @invar The faction of each unit must be a valid faction for any unit. | isValidFaction(getFaction())
	 */
	 ...
	 * @effect The faction of this new unit is set to the given faction. | this.setFaction(faction)
	 */
	public Unit(String faction) throws IllegalArgumentException {
